...
for (const inputExpression of inputExpressions) {
    const result = (0, naive_top_down_depth_first_search_1.naiveTopDownDepthFirstSearchParse)(right_recursive_binary_addition_expressions_1.rightRecursiveBinaryAdditionExpressionsGrammar, inputExpression, true);
